...
from app.utils.http_upstream import cliente_id_desde_respuesta, unwrap_upstream_error
...
async def crear(
    ...
    resultado = upstream.status_code
    cid = cliente_id_desde_respuesta(upstream) or ""

    await registrar_operacion("CREAR", username, cid or "sin_id", resultado)
